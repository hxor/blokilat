...
@section('content')
  <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header">Posts <a href="{{ route('post.create') }}" class="btn btn-success"> Add Post</a> </h1>
      </div>
      <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                  {!! Form::model($post, ['route' => ['post.destroy', $post->id], 'method' => 'DELETE']) !!}
                                    <a href="{{ route('post.show', $post->id) }}"> <button type="button" class="btn btn-primary btn-xs">Show</button> </a>
                                    <a href="{{ route('post.edit', $post->id) }}"> <button type="button" class="btn btn-warning btn-xs">Edit</button> </a>
