...
@section('content')
  <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header">Categories <a href="{{ route('category.create') }}" class="btn btn-success"> Add Category</a> </h1>
      </div>
      <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                  {!! Form::model($category, ['route' => ['category.destroy', $category->id], 'method' => 'DELETE']) !!}
                                    <a href="{{ route('category.show', $category->id) }}"> <button type="button" class="btn btn-primary btn-xs">Show</button> </a>
                                    <a href="{{ route('category.edit', $category->id) }}"> <button type="button" class="btn btn-warning btn-xs">Edit</button> </a>
